...
namespace WPAppStudio.Ioc
{
    ...
    public class Container : IIoc.IContainer
    {
        ...
        public Container()
        {
            ...
            _currentContainer.RegisterType<IViewModels.IFreshCoffee_ListViewModel, ViewModels.FreshCoffee_ListViewModel>();
            _currentContainer.RegisterType<IViewModels.IFreshCoffee_DetailViewModel, ViewModels.FreshCoffee_DetailViewModel>();
            ...
            {
				_currentContainer.RegisterType<Repositories.IFreshCoffee_FreshCoffee, Repositories.FreshCoffee_FreshCoffee>(new ContainerControlledLifetimeManager());
			}
			else
			{
				_currentContainer.RegisterType<Repositories.IFreshCoffee_FreshCoffee, Repositories.FakeFreshCoffee_FreshCoffee>(new ContainerControlledLifetimeManager());
