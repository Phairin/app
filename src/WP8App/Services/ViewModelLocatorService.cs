...
namespace WPAppStudio.Services
{
    ...
    public class ViewModelLocatorService
    {
        ...
        /// <summary>
        /// Gets the reference to a FreshCoffee_ListViewModel.
        /// </summary>
		public IViewModels.IFreshCoffee_ListViewModel FreshCoffee_ListViewModel
        {
            get { return _container.Resolve<IViewModels.IFreshCoffee_ListViewModel>(); }
        }

        /// <summary>
        /// Gets the reference to a FreshCoffee_DetailViewModel.
        /// </summary>
		public IViewModels.IFreshCoffee_DetailViewModel FreshCoffee_DetailViewModel
        {
            get { return _container.Resolve<IViewModels.IFreshCoffee_DetailViewModel>(); }
        }
		/// <summary>
