...
{
    /// <summary>
    /// Fake FreshCoffeeSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class FakeFreshCoffee_FreshCoffee : IFreshCoffee_FreshCoffee 
    {
        ...
        public ObservableCollection<Entities.FreshCoffeeSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.FreshCoffeeSchema> 
			{ 
			...
			return new ObservableCollection<Entities.FreshCoffeeSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.FreshCoffeeSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of FreshCoffeeSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.FreshCoffeeSchema>.FilterCollection(filter, GetData());
        }
